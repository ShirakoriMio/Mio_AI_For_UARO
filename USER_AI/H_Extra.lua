...
-- Level 5, Mode 2 (Spam)
H_SkillList = {{S_CAPRICE, 5, 1, 2, 1, 0}}
-- Level 5, Mode 2 (Spam)
H_SkillList = {{S_MOONLIGHT, 5, 1, 2, 1, 0}}

AutoSkillCooldown[HVAN_CAPRICE] = 100

-- Essential for hybrid Melee + Casting
FriendAttack = FriendAttack or {}
FriendAttack[MOTION_ATTACK]=1
FriendAttack[MOTION_ATTACK2]=1
